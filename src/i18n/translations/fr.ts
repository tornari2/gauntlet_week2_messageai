...
export default {
  ...
  chat: {
    ...
    online: 'En ligne',
    offline: 'Hors ligne',
    statusUnknown: 'Statut inconnu (vous êtes hors ligne)',
  ...
  lastSeen: {
    justNow: 'Actif à l\'instant',
    minutesAgo: 'Actif il y a {{minutes}}m',
    hoursAgo: 'Actif il y a {{hours}}h',
    yesterday: 'Actif hier',
